...
public class ProductController {
    ...
    public List<Product> getProductsByCategoryAndGroup(@PathVariable String category, @PathVariable String group) {
    ...
    public ResponseEntity<ErrorDTO> illegalArgumentExceptionHandler(IllegalArgumentException exception) {
        return new ResponseEntity<>(
                ErrorDTO.fromException(new NotFoundException(NOT_FOUND_MESSAGE_FORMAT, HttpStatus.NOT_FOUND.name())),
